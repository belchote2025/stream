...
android {
    namespace = "com.streaming.tv"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.streaming.tv"
        ...
        // API Configuration
        buildConfigField("String", "BASE_URL", "\"https://tu-dominio.com/streaming-platform/\"")
...
dependencies {
    ...
    implementation("androidx.media3:media3-ui-leanback:1.2.0")  // TV-specific UI
